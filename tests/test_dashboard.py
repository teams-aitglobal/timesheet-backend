...
async def test_employee_dashboard_shape(client: AsyncClient, super_admin, program_manager, employee):
...
async def test_manager_dashboard_shape(client: AsyncClient, super_admin, program_manager, employee):
    admin, admin_password = super_admin
    ...
    assert body["projects"][0]["hours_logged"] == 0.0


async def test_admin_dashboard_shape(client: AsyncClient, super_admin, program_manager):
    admin, admin_password = super_admin
    manager, _ = program_manager
